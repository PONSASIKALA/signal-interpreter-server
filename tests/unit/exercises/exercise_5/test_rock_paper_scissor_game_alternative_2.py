...
from lesson_2.exercise_5.rock_paper_scissor_game import decide_who_will_win, RandomClass, play_game
...
def test_get_robot_choice():
    with patch("lesson_2.exercise_5.rock_paper_scissor_game.random.choice") as mock_choice:
...
def test_play_game():
    with patch("builtins.input", return_value="rock"):
        with patch.object(RandomClass, "get_robot_choice", return_value="scissor"):
            with patch("lesson_2.exercise_5.rock_paper_scissor_game.decide_who_will_win") as mock_decide_who_will_win:
